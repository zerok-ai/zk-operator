...
perl -pi -e "s#zkInitContainerRepo: \".*\"#zkInitContainerRepo: \"$ZK_INIT_REPO\"#" $THIS_DIR/values.yaml
perl -pi -e "s#zkInitContainerTag: \".*\"#zkInitContainerTag: \"$ZK_INIT_TAG\"#" $THIS_DIR/values.yaml